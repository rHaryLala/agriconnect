    ...
    <div>
      ...
      <div key={activeTab} className="animate-content-in mt-4">
        ...
        {activeTab === "transactions" && (
          <FinanceTransactionsTab transactions={transactions} isLoading={isLoading} canEdit={canEdit} onAdd={addTransaction} onUpdate={updateTransaction} onDelete={deleteTransaction} />
        )}
