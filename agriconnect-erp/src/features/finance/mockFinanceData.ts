...
export const SEED_TRANSACTIONS: FinanceTransaction[] = [
  { id: "t-1", type: "recette", categorie: "Vente d'œufs — poules pondeuses", montant: 480_000, date: "2026-06-10", description: "Vente hebdomadaire" },
  ...
  { id: "t-8", type: "recette", categorie: "Vente d'œufs — poules pondeuses", montant: 505_000, date: "2026-08-16", description: "Vente hebdomadaire" },
]