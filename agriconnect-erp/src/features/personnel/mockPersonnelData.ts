...
export const SEED_EMPLOYES: Employe[] = [
  { id: "emp-1", nom: "Hary Lala", fonction: "Magasinier de la Ferme", departement: "Logistique", telephone: "034 12 345 67", matriculeUaz: "UAZ-0231", clientId: "cl-3", statut: "actif" },
