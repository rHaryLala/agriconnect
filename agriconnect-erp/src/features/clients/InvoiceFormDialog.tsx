...
type SubmitInvoice = (values: Omit<Invoice, "id" | "numero">) => Promise<void>
...
function defaultValuesFor(clients: Client[], articles: StockArticle[]): FormValues {
  return {
...
function InvoiceForm({ clients, articles, onSubmit, onCancel }: InvoiceFormProps) {
  ...
  const {
    ...
    defaultValues: defaultValuesFor(clients, articles),
  })
