...
import { RizTab } from "./RizTab"
import { HaricotsTab } from "./HaricotsTab"
...
export default function ProductionPage() {
  ...
  const FIXED_TABS = [
    ...
    { id: "riz", label: t("production.tabs.riz") },
    { id: "haricots", label: t("production.tabs.haricots") },
  ...
  return (
    <div>
      ...
      <div key={activeTab} className="animate-content-in mt-4">
        ...
        {activeTab === "riz" && <RizTab canEdit={canEdit} />}
        {activeTab === "haricots" && <HaricotsTab canEdit={canEdit} />}
