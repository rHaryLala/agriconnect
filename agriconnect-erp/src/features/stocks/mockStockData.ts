...
export const SEED_MOVEMENTS: StockMovement[] = [
  { id: "m-1", articleId: "a-oeufs", type: "sortie", quantite: 80, date: "2026-08-15", origine: "Vente client Rakoto" },
  { id: "m-2", articleId: "a-mais", type: "entree", quantite: 150, date: "2026-08-14", origine: "Achat fournisseur" },
]